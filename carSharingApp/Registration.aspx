<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="carSharingApp.Registration" %>
            ...
            <table cellpadding="5" cellspacing="5" class="auto-style1">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" Display="Dynamic" ErrorMessage="Please Enter Your username" ForeColor="Red" SetFocusOnError="True" ControlToValidate="UserNameTextBox">*</asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="PassWordTextBox" Display="Dynamic" ErrorMessage="Please Enter a strong password with Uppercase,Lowercase,Number, Character(from `#?!@$%^&*-`)  and at least 8 digit   " ForeColor="Red" SetFocusOnError="True" ValidationExpression="^(?=.*?[A-Z])(?=.*?[a-z])(?=.*?[0-9])(?=.*?[#?!@$%^&amp;*-]).{8,}$">*</asp:RegularExpressionValidator>
                    </td>
                </tr>
                <tr>
